...
Esta documentação explora os templates de issues disponíveis e oferece um conjunto de componentes prontos para serem reutilizados.
...
3. **Matenha o status atualizado**: mova a issue no board conforme avança (To Do → In Progress → To Review).
